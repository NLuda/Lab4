...
public class SaveChanges extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String query = String.format("update autos set name='%s', body='%s', transmission='%s', year='%d', mileage='%d' where auto_index='%d'",
                auto.getName(),auto.getBody(),auto.getTransmission(),auto.getYear(),auto.getMileage(),auto.getIdInDatabase());
        try {
